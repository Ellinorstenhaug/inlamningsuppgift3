function uppgift6() {
    ...
    function fakultet(n) {
        if (n > 0 && n <= 170) { // Den beräknar fakulteten för alla naturliga tal. Gränsen för javascripts MAX_VALUE (infinity) går vid 171!
            ...
            alert('Du har nått javascripts MAX_VALUE!\nJavascipt klarar av att beräkna fakultet på max 170!.');
